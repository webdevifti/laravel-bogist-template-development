        ...
        <div class="col-12 col-md-7 col-lg-8 order-md-1">
          <div class="category__header">
            ...
            <div class="category__header__filter">
              {{-- <a class="category__header__filter__item" href="javascript:void(0)" data-layout="grid"><i class="fas fa-th"></i></a>
              <a class="category__header__filter__item active" href="javascript:void(0)" data-layout="list"><i class="fas fa-bars"></i></a> --}}
              <a href="/grid/{{ $cat }}" class=""><i class="fas fa-th"></i></a>
              <a href="/list/{{ $cat }}" class="active"><i class="fas fa-bars"></i></a>
            </div>
          </div>
          <div class="category_content">
            @include('template-parts.list_post')
          </div>
